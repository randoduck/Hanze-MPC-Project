...
#include <arpa/inet.h>  /* Provides htonl and ntohl */

static inline uint32_t field_hton(field_t v) { return htonl((uint32_t)v); }
static inline field_t  field_ntoh(uint32_t v) { return (field_t)ntohl(v); }
